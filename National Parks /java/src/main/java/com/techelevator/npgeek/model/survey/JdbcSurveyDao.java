...
public class JdbcSurveyDao implements SurveyDao {
	...
	public void addSurvey(Survey survey) {
		...
		jdbcTemplate.update(SQLString, survey.getParkCode(), survey.getEmailAddress(), survey.getState(),
	...
	public LinkedHashMap<String, Integer> getSurveysWithOneCountMin() {
		...
		SqlRowSet result = jdbcTemplate.queryForRowSet(
				"SELECT survey_result.parkcode, park.parkname, COUNT(survey_result.parkcode) AS parkcount\n"
